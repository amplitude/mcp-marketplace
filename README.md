...
| Plugin | Description |
|--------|-------------|
| [amplitude](./plugins/amplitude/) | 20+ analysis skills covering charts, dashboards, experiments, session replays, reliability, AI agent analytics, and more |
| [instrumentation](./plugins/instrumentation/) | Code-aware instrumentation skills that read your codebase and produce tracking plans aligned with existing patterns |

---

## Amplitude Plugin

The amplitude plugin turns your AI assistant into an expert product analyst. Skills are organized into six areas:
...
The instrumentation plugin reads your codebase and helps you plan, prioritize, and implement analytics tracking. Skills are designed to run as a pipeline — or individually.
...
/plugin install amplitude@instrumentation
```
