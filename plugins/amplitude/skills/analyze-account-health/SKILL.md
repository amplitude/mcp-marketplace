...
Use `Amplitude:use_amplitude_ai_feedback` to see what's available.

**Get feedback insights:**
Use `Amplitude:use_amplitude_ai_feedback` filtered by:
...
For top 3-5 insights, use `Amplitude:use_amplitude_ai_feedback` to get quotes.
