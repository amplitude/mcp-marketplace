...
3. If the user supplies recent release context, use it as a hypothesis for any regression.
...
- **User asks "did the release break anything" without a date.** Ask for the deploy date or release context before correlating the data.
